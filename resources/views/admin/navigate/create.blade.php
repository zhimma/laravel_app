<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <form class="form-horizontal form-label-left j_create_navigate" data-url="{{ route('navigate.store') }}" action="{{ route('navigate.store') }}"
          method="POST">
        {{ csrf_field() }}
...
<script>
    seajs.use('module_js/navigate/create', function (navigate) {
        navigate.init();
        window.create_navigate = navigate.create_navigate;
    })
</script>
