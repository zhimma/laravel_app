...
<!-- Flot plugins -->
<script src="{{ asset('admin/js/flot/jquery.flot.orderBars.js') }}"></script>
<script src="{{ asset('admin/js/flot/date.js') }}"></script>
<script src="{{ asset('admin/js/flot/jquery.flot.spline.js') }}"></script>
