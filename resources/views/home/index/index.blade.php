            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="flexslider animate-box">
                        <ul class="slides">
                            <li style="background-image: url({{ asset('home/images/img_bg_1.jpg') }});">
                ...
                <div class="col-md-4">
                    <a href="#" class="featured text-center animate-box" style="background-image: url({{ asset('home/images/img_bg_3.jpg') }});">
                        <div class="desc">
                    ...
                    <a href="#" class="featured text-center animate-box" style="background-image: url({{ asset('home/images/img_bg_2.jpg') }});">
                        <div class="desc">
                            <span class="date">Dec 25, 2016</span>
